...
Column {
    ...
    TextEdit {
        ...
        +"<body><h2 align=\"center\">用户指南</h2>"
              + "<p>本软件 eBookReader用于阅读FB2, FB2ZIP, EPUB (版本 2) 格式的电子书，不支持DRM格式."
              +"<h3>1. 主窗口 (书库)</h3>"
              +"<h4>菜单</h4><ul><li><i>添加</i> - 向书库中导入(添加)一本新书. "
              +"FB2, FB2ZIP 和 EPUB将被转换成内部的EBR格式. 你可以直接导入书籍，或者从文件夹或者手机中导入. "
              +"当全部导入完成后，你可以删除原文件来释放磁盘空间. "
              +"开头为 '.' 的文件在快速添加时将被忽略.</li>"
              +"<li><i>设置</i> - 打开程序的设置窗口.</li>"
              +"<li><i>编辑书库</i> - 你可以轻易的从书库中删除书本.</li>"
              +"<li><i>帮助和信息</i> - 查看用户手册和有关程序的信息.</li>"
              +"<li><i>退出</i> - 退出程序.</li></ul>"
              +"<h4>书库操作</h4>"
              +"<ul><li><i>短按 本书记录</i> - 打开书本.</li>"
              +"<li><i>长按 本书记录</i> - 打开本书菜单.</li></ul>"
              +"<h4>书本菜单</h4>"
              ...
              +"<h3>2. 书本窗口</h3>"
              +"<h4>菜单</h4>"
              +"<ul><li><i>设置</i> - 打开程序设置菜单.</li>"
              +"<li><i>屏幕方向</i> - 选择屏幕显示模式 (白天模式或夜间模式，全屏，等等).</li>"
              +"<li><i>导航</i> - 查看书本导航菜单。</li>"
              +"<li><i>书签</i> - 查看书签菜单。</li>"
              +"<li><i>退出</i> - 退出程序</li></ul>"
              +"<h4>书本内容操作</h4>"
              +"<ul><li><i>下箭头键向下翻页 (或触屏屏幕)</i> - 进入下一页。</li>"
              +"<li><i>上箭头键向上翻页 (或触屏屏幕)</i> - 返回上一页。</li>"
              +"<li><i>使用手势 (2-手指按住，向外移动)</i> - 放大内容。"
              +"<li><i>使用手势 (2-手指按住，向内移动)</i> - 缩小内容。"
              +" 放大和缩小内容的目的是方便超链接时使用，"
              ...
              +"<li><i>删除原文件</i> - 从手机中删除(FB2, Zip, ePub)格式文件。"
